...
async fn main() {
    ...
    let jobs = vec![
        Job { id: "job-001".to_string(), url: "https://example.com".to_string(), use_browser: false,
            actions: vec![Action::Extract { selector: "p".to_string(), attr: None }] },
        Job { id: "job-002".to_string(), url: "https://example.org".to_string(), use_browser: true,
            actions: vec![Action::WaitFor { selector: "h1".to_string(), timeout_ms: 5000 }] },
    ];
